    ...
    getStageDetailContent(stage) {
        const stageDetails = {
            1: {
                ...
                whyThisMatters: "Without this foundation, people can't ride safely or confidently. Skipping it leads to misuse, fear, or unrealistic expectations later.",
                whatToFocus: [
                    "Ensure everyone has access to AI tools and knows how to get started",
                    "Provide hands-on training sessions and practical demos",
                    "Create clear documentation about available tools and their use cases",
                    "Set up safe environments for experimentation without fear of mistakes"
                ]
            },
            2: {
                title: "Stage 2: Riding with Training Wheels",
                ...
                whyThisMatters: "This stage builds trust and confidence. Guardrails make adoption safer and faster, not slower.",
                whatToFocus: [
            ...
            3: {
                ...
                notPastThisStage: [
                    "Workflows still look mostly the same as before",
                ...
                whatToFocus: [
                    "Redesign workflows to integrate AI naturally",
                    "Make AI the default path, with manual processes as backup",
                    "Build team capabilities in prompt engineering and AI optimization",
            ...
            4: {
                ...
                whyThisMatters: "This is how AI becomes scalable and differentiated. Design replaces ad hoc usage.",
                whatToFocus: [
                    "Invest in custom AI solutions that fit your team's specific needs",
                    "Create reusable templates and integrations",
                    "Build internal expertise in AI customization and configuration",
                    "Establish governance for managing and scaling custom AI solutions"
                ]
            },
            5: {
                title: "Stage 5: Riding Without Thinking",
                ...
                whyThisMatters: "This is how AI becomes operational. AI is no longer a project—it's a dependable, managed capability the business runs on."
            }
        };
